    ...
    return (
        <div>
                                    ...
                                    <ul className="navi_2_dropdown">
                                        <li className="parent">
                                            ...
                                            <ul className="dropdown-menu-right">
                                                ...
                                                <li>
                                                    <a href="view_profilehtml"> <i className="fas fa-caret-right" /> my profile</a>
                                                </li>
                                                <li>
            ...
            <div className="l-main">
                ...
                <div className="deposit_list_wrapper float_left">
                    <div className="row">
                    ...
                    <div className="crm_customer_table_main_wrapper deposit_tables float_left">
                        <div className="row">
                            <div className="col-md-12 col-lg-12 col-sm-12 col-12">
                                <div className="deposit_tab_wrapper">
                                    <ul className="nav nav-tabs">
                                        <li className="nav-item"> <a className="nav-link active" data-toggle="tab" href="#home"> active deposit</a>
                                        </li>
                                        <li className="nav-item"> <a className="nav-link " data-toggle="tab" href="#menu1">matured deposit</a>
                                        </li>
                                        <li className="nav-item"> <a className="nav-link" data-toggle="tab" href="#menu2"> pending deposit</a>
                                        </li>
                                        <li className="nav-item"> <a className="nav-link" data-toggle="tab" href="#menu3"> released deposit</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                            ...
                                            <div className="col-lg-12 col-md-12 col-12">
                                                <div className="table-responsive">
                                                    <table className="myTable table datatables cs-table crm_customer_table_inner_Wrapper">
                                                        <thead>
                                                            <tr>
                                                                <th className="width_table1">plan name</th>
                                                                <th className="width_table1">deposit amount</th>
                                                                <th className="width_table1">status</th>
                                                                <th className="width_table1">investment date</th>
                                                                <th className="width_table1">action</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            <tr className="background_white">
                                                                ...
                                                                <td>
                                                                    <div className="pretty p-svg p-curve">$1000.00</div>
                                                                </td>
                                                                <td>
                                                                    <div className="pretty p-svg p-curve deposit_active">active</div>
                                                                </td>
                                                                <td>
                                                                    <div className="pretty p-svg p-curve">03/07/2019</div>
                                                                </td>
                                                                <td>
                                                                    <nav className="navbar navbar-expand">
                                                                        <ul className="navbar-nav">
                                                                            ...
                                                                            <li className="nav-item dropdown">
                                                                                <a className="nav-link dropdown-toggle" href="#" data-toggle="dropdown"> <i className="fa fa-ellipsis-v" />
                                                                                </a>
                                                                                <div className="dropdown-menu"> <a className="dropdown-item" href="#">search</a>
                                                            ...
                                                            <tr className="background_white">
                                                                ...
                                                                <td>
                                                                    <div className="pretty p-svg p-curve">$22000.00</div>
                                                                </td>
                                                                <td>
                                                                    <div className="pretty p-svg p-curve deposit_active">active</div>
                                                                </td>
                                                                <td>
                                                                    <div className="pretty p-svg p-curve">20/07/2019</div>
                                                                </td>
                                                                <td>
                                                                    <nav className="navbar navbar-expand">
                                                                        <ul className="navbar-nav">
                                                            ...
                                                            <tr className="background_white">
                                                                ...
                                                                <td>
                                                                    <div className="pretty p-svg p-curve">$2000.00</div>
                                                                </td>
                                                                <td>
                                                                    <div className="pretty p-svg p-curve deposit_active">active</div>
                                                                </td>
                                                            ...
                                                            <tr className="background_white">
                                                                ...
                                                                <td>
                                                                    <div className="pretty p-svg p-curve">2/08/2019</div>
                                                                </td>
                                                                <td>
                                                                    <nav className="navbar navbar-expand">
                                                                        <ul className="navbar-nav">
                                                            ...
                                                            <tr className="background_white">
                                                                ...
                                                                <td>
                                                                    <div className="pretty p-svg p-curve">$11000.00</div>
                                                                </td>
                                                                <td>
                                                                    <div className="pretty p-svg p-curve deposit_active">active</div>
                                                                </td>
                                                                <td>
                                                                    <div className="pretty p-svg p-curve">31/07/2019</div>
                                                                </td>
                                                                <td>
                                                                    <nav className="navbar navbar-expand">
                                                                        <ul className="navbar-nav">
                                                            ...
                                                            <tr className="background_white">
                                                                ...
                                                                <td>
                                                                    <div className="pretty p-svg p-curve">$6500.00</div>
                                                                </td>
                                                                <td>
                                                                    <div className="pretty p-svg p-curve deposit_active">active</div>
                                                                </td>
                                                                <td>
                                                                    <div className="pretty p-svg p-curve">21/08/2019</div>
                                                                </td>
                                                                <td>
                                                                    <nav className="navbar navbar-expand">
                                                                        <ul className="navbar-nav">
                                                            ...
                                                            <tr className="background_white">
                                                                ...
                                                                <td>
                                                                    <div className="pretty p-svg p-curve">$86000.00</div>
                                                                </td>
                                                                <td>
                                                                    <div className="pretty p-svg p-curve deposit_active">active</div>
                                                                </td>
                                                                <td>
                                                                    <div className="pretty p-svg p-curve">2/09/2019</div>
                                                                </td><td>
                                                                    <nav className="navbar navbar-expand">
                                                                        <ul className="navbar-nav">
                                                                            {/* Dropdown */}
                                                            ...
                                                            <tr className="background_white">
                                                                ...
                                                                <td>
                                                                    <div className="pretty p-svg p-curve">$96000.00</div>
                                                                </td>
                                                                <td>
                                                                    <div className="pretty p-svg p-curve deposit_active">active</div>
                                                                </td>
                                                            ...
                                                            <tr className="background_white">
                                                                ...
                                                                <td>
                                                                    <div className="pretty p-svg p-curve">$06000.00</div>
                                                                </td>
                                                                <td>
                                                                    <div className="pretty p-svg p-curve deposit_active">active</div>
                                                                </td>
                                                                <td>
                                                                    <div className="pretty p-svg p-curve">24/09/2019</div>
                                                                </td><td>
                                                                    <nav className="navbar navbar-expand">
                                                                        <ul className="navbar-nav">
                                                                            {/* Dropdown */}
                                                            ...
                                                            <tr className="background_white">
                                                                ...
                                                                <td>
                                                                    <div className="pretty p-svg p-curve">2/11/2019</div>
                                                                </td><td>
                                                                    <nav className="navbar navbar-expand">
                                                                        <ul className="navbar-nav">
                                                                            {/* Dropdown */}
                                                            ...
                                                            <tr className="background_white">
                                                                ...
                                                                <td>
                                                                    <div className="pretty p-svg p-curve">$55000.00</div>
                                                                </td>
                                                                <td>
                                                                    <div className="pretty p-svg p-curve deposit_active">active</div>
                                                                </td>
                                                                <td>
                                                                    <div className="pretty p-svg p-curve">12/09/2019</div>
                                                                </td><td>
                                                                    <nav className="navbar navbar-expand">
                                                                        <ul className="navbar-nav">
                                                                            {/* Dropdown */}
                                                            ...
                                                            <tr className="background_white">
                                                                ...
                                                                <td>
                                                                    <div className="pretty p-svg p-curve">$86850.00</div>
                                                                </td>
                                                                <td>
                                                                    <div className="pretty p-svg p-curve deposit_active">active</div>
                                                                </td>
                                                                <td>
                                                                    <div className="pretty p-svg p-curve">07/09/2019</div>
                                                                </td><td>
                                                                    <nav className="navbar navbar-expand">
                                                                        <ul className="navbar-nav">
                                                                            {/* Dropdown */}
                                                            ...
                                                            <tr className="background_white">
                                                                ...
                                                                <td>
                                                                    <div className="pretty p-svg p-curve">$006000.00</div>
                                                                </td>
                                                                <td>
                                                                    <div className="pretty p-svg p-curve deposit_active">active</div>
                                                                </td>
                                                    ...
                                                    <table className="myTable table datatables cs-table crm_customer_table_inner_Wrapper">
                                                        ...
                                                        <tbody>
                                                            <tr className="background_white">
                                                                ...
                                                                <td>
                                                                    <div className="pretty p-svg p-curve">$4000.00</div>
                                                                </td>
                                                                <td>
                                                                    <div className="pretty p-svg p-curve deposit_matured">matured</div>
                                                                </td>
                                                                <td>
                                                                    <div className="pretty p-svg p-curve">02/07/2019</div>
                                                                </td>
                                                                <td>
                                                                    <nav className="navbar navbar-expand">
                                                                        <ul className="navbar-nav">
                                                    ...
                                                    <table className="myTable table datatables cs-table crm_customer_table_inner_Wrapper">
                                                        ...
                                                        <tbody>
                                                            <tr className="background_white">
                                                                ...
                                                                <td>
                                                                    <div className="pretty p-svg p-curve deposit_pending">pending</div>
                                                                </td>
                                                                <td>
                                                                    <div className="pretty p-svg p-curve">03/07/2019</div>
                                                                </td>
                                                    ...
                                                    <table className="myTable table datatables cs-table crm_customer_table_inner_Wrapper">
                                                        ...
                                                        <tbody>
                                                            <tr className="background_white">
                                                                ...
                                                                <td>
                                                                    <div className="pretty p-svg p-curve release">Waiting for admin Approval</div>
                                                                </td>
                                                                <td>
                                                                    <div className="pretty p-svg p-curve">03/07/2019</div>
                                                                </td>
