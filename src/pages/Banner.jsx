    ...
    return (
        <div>
            ...
            <div className="l-main">
                ...
                <div className="banner_top_wrapper float_left">
                    <div className="row">
                        ...
                        <div className="col-md-12 col-lg-12 col-sm-12 col-12">
                            <div className="view_profile_wrapper float_left">
                                <div className="row">
                                    <div className="col-md-12 col-lg-12 col-sm-12 col-12">
                                        <div className="profile_view_img banner_img_wrapper">
                                            <img src="images/banner1.jpg" alt="post_img" />
                                        </div>
                                        <div className="profile_width_cntnt banner_cnctnt_wrapper">
                                            <h4>JPEG or PNG 1000x1000px Thumbnail</h4>
                                            <div className="width_50">
                                                <input type="file" id="input-file-now-custom-23" className="dropify" data-height={90} /><span className="post_photo">browse image</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-md-12 col-lg-12 col-sm-12 col-12">
                                        <div className="profile_view_img banner_img_wrapper gtgt">
                                            <img src="images/banner1.jpg" alt="post_img" />
                                        </div>
                                        <div className="profile_width_cntnt banner_cnctnt_wrapper">
                                            <h4>JPEG or PNG 1000x1000px Thumbnail</h4>
                                            <div className="width_50">
                                                <input type="file" id="input-file-now-custom-3" className="dropify" data-height={90} /><span className="post_photo">browse image</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
