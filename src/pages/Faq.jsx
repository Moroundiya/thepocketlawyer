...
function Faq() {
    return (
        <div>
            ...
            {/* FAQ wrapper start */}
            <div className="inner_faq_wrapper fixed_portion float_left">
                <div className="container">
                    <div className="row">
                    ...
                    <div id="accordion" role="tablist" className="inner_faq_section">
                        <div className="row">
                            ...
                            <div className="col-lg-6 col-md-12 col-sm-12 col-12">
                                <div className="card">
                                    ...
                                    {/* Card Content */}
                                    <div id="collapseeight" className="collapse" role="tabpanel" aria-labelledby="headingeight" data-parent="#accordion" style={{}}>
                                        <div className="card-body">
                                            <div className="card_img">
                                                <img src="images/ac1.jpg" alt="img" />
                                            </div>
                                ...
                                <div className="card">
                                    ...
                                    <div className="card_pagee" role="tab" id="headingthe">
                                        <h5 className="h5-md">
                                            <a className="collapsed" data-toggle="collapse" href="#collapsethe" role="button" aria-expanded="false" aria-controls="collapsethe">
                                                User Guide: Getting Started
                                            </a>
                                        </h5>
                                    </div>
                                    {/* Card Content */}
                                    <div id="collapsethe" className="collapse" role="tabpanel" aria-labelledby="headingthe" data-parent="#accordion" style={{}}>
                                        <div className="card-body">
                                            <div className="card_img">
                                                <img src="images/ac1.jpg" alt="img" />
                                            </div>
                                ...
                                <div className="card">
                                    ...
                                    <div className="card_pagee" role="tab" id="headingthey">
                                        <h5 className="h5-md">
                                            <a className="collapsed" data-toggle="collapse" href="#collapsethey" role="button" aria-expanded="false" aria-controls="collapsenine">
                                                Pixel perfect and responsive
                                            </a>
                                        </h5>
                                    </div>
                                    {/* Card Content */}
                                    <div id="collapsethey" className="collapse" role="tabpanel" aria-labelledby="headingthey" data-parent="#accordion" style={{}}>
                                        <div className="card-body">
                                            <div className="card_img">
                                                <img src="images/ac1.jpg" alt="img" />
                                            </div>
                                ...
                                <div className="card">
                                    <div className="card_pagee" role="tab" id="headingnine">
                                        <h5 className="h5-md">
                                            <a className="collapsed" data-toggle="collapse" href="#collapsenine" role="button" aria-expanded="false" aria-controls="collapsenine">
                                                Imagination Is The Beginning
                                            </a>
                                        </h5>
                                    </div>
                                    <div id="collapsenine" className="collapse" role="tabpanel" aria-labelledby="headingnine" data-parent="#accordion" style={{}}>
                                        <div className="card-body">
                                            <div className="card_img">
                                                <img src="images/ac2.jpg" alt="img" />
                                            </div>
                                ...
                                <div className="card">
                                    <div className="card_pagee" role="tab" id="headingTen">
                                        <h5 className="h5-md">
                                            <a className="collapsed" data-toggle="collapse" href="#collapseTen" role="button" aria-expanded="false" aria-controls="collapseTen">
                                                Clean and Unique
                                            </a>
                                        </h5>
                                    </div>
                                ...
                                <div className="card">
                                    <div className="card_pagee" role="tab" id="headingele">
                                        <h5 className="h5-md">
                                            <a className="collapsed" data-toggle="collapse" href="#collapseele" role="button" aria-expanded="false" aria-controls="collapseele">
                                                Deeply Customisable Theme
                                            </a>
                                        </h5>
                                    </div>
                                    <div id="collapseele" className="collapse" role="tabpanel" aria-labelledby="headingele" data-parent="#accordion">
                                        <div className="card-body">
                                            <div className="card_img">
                                                <img src="images/ac1.jpg" alt="img" />
                                            </div>
                                ...
                                <div className="card">
                                    <div className="card_pagee" role="tab" id="headingtwe">
                                        <h5 className="h5-md">
                                            <a className="collapsed" data-toggle="collapse" href="#collapsetew" role="button" aria-expanded="false" aria-controls="collapsetew">
                                                How do I use the features ?
                                            </a>
                                        </h5>
                                    </div>
                                    <div id="collapsetew" className="collapse" role="tabpanel" aria-labelledby="headingtwe" data-parent="#accordion">
                                        <div className="card-body">
                                            <div className="card_img">
                                                <img src="images/ac3.jpg" alt="img" />
                                            </div>
                                            ...
                                            <div className="col-lg-12 col-md-12">
                                                <div className="form-pos">
                                                    <div className="form-group i-name">
                                                        <input type="text" className="form-control require" name="full_name" required id="namTen-first" placeholder="Name*" />
                                                    </div>
                                                </div>
                                            </div>
                                            {/* /.col-md-12 */}
                                            <div className="col-lg-12 col-md-12">
                                                <div className="form-e">
                                                    <div className="form-group i-email">
                                                        ...
                                                        <input type="email" className="form-control require" name="email" required id="emailTen" placeholder=" Email*" data-valid="email" data-error="Email should be valid." />
                                                    </div>
                                                </div>
                                            </div>
                                            {/* /.col-md-12 */}
                                            <div className="col-lg-12 col-md-12">
                                                <div className="form-s">
                                                    <div className="form-group i-subject">
                                                        <input type="text" className="form-control" name="subject" required id="subjectTen" placeholder="Question*" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-md-12">
                                                <div className="form-m">
                                                    <div className="form-group i-message">
                                                        <textarea className="form-control require" name="message" required rows={4} id="messageTen" placeholder="Message" defaultValue={""} />
                                                    </div>
                                                </div>
                                            </div>
                                            {/* /.col-md-12 */}
                                            <div className="col-md-12">
                                                <div className="tb_es_btn_div">
                                                    ...
                                                    <div className="tb_es_btn_wrapper conatct_btn2">
