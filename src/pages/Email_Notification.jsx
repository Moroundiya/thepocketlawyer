    ...
    return (
        <div>
            ...
            <div className="l-main">
                ...
                {/*  email wrapper start */}
                <div className="email_notifcation_wrapper float_left">
                    <div className="row">
                    ...
                    <div className="email_notify_top float_left">
                        <div className="row">
                            <div className="col-xl-3 col-md-6 col-lg-4 col-sm-12 col-12">
                                <div className="email_notify float_left">
                                    <ul className="job_field">
                                        <li>
                                            <input type="checkbox" id="c1" name="cb" />
                                            <label htmlFor="c1"> Deposit Confirmation</label>
                                        </li>
                                        <li>
                                            <input type="checkbox" id="c2" name="cb" />
                                            <label htmlFor="c2"> Deposit Request</label>
                                        </li>
                                        <li>
                                            <input type="checkbox" id="c3" name="cb" />
                                            <label htmlFor="c3">Change Password</label>
                                        </li>
                                        <li>
                                            <input type="checkbox" id="c4" name="cb" />
                                            <label htmlFor="c4">Support tickets</label>
                                        </li>
                                        <li>
                                            <input type="checkbox" id="c5" name="cb" />
                                            <label htmlFor="c5">Fund Transfer Credit</label>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                ...
                                <div className="email_notify float_left">
                                    <ul className="job_field">
                                        <li>
                                            ...
                                            <label htmlFor="c6"> Payout Confirmation</label>
                                        </li>
                                        <li>
                                            <input type="checkbox" id="c7" name="cb" />
                                            <label htmlFor="c7"> Exchange Confirmation</label>
                                        </li>
                                        <li>
                                            <input type="checkbox" id="c8" name="cb" />
                                            <label htmlFor="c8">New referral</label>
                                        </li>
                                        <li>
                                            <input type="checkbox" id="c9" name="cb" />
                                            <label htmlFor="c9"> Profile Update</label>
                                        </li>
                                        <li>
                                            <input type="checkbox" id="c10" name="cb" />
                                            <label htmlFor="c10">Email Login Verification</label>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                ...
                                <div className="email_notify float_left">
                                    <ul className="job_field">
                                        <li>
                                            ...
                                            <label htmlFor="c11">Payout Request</label>
                                        </li>
                                        <li>
                                            <input type="checkbox" id="c12" name="cb" />
                                            <label htmlFor="c12">change Pin</label>
                                        </li>
                                        <li>
                                            <input type="checkbox" id="c13" name="cb" />
                                            <label htmlFor="c13">Referral Commission Earned</label>
                                        </li>
                                        <li>
                                            <input type="checkbox" id="c14" name="cb" />
                                            <label htmlFor="c14">Fund Transfer Debit</label>
                                        </li>
                                        <li>
                                            <input type="checkbox" id="c15" name="cb" />
                                            <label htmlFor="c15">Email IP Verification</label>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div className="col-xl-12 col-md-12 col-lg-12 col-sm-12 col-12">
                                <div className="about_btn account_data_btn float_left">
                                    <ul>
                                        <li>
                                            <a href="#">change account data</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
