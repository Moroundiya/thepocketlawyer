                    ...
                    <div className="row">
                        <div className="col-md-12 col-lg-6 col-sm-12 col-12">
                            <div className="about_img_wrapper">
                                <img src="images/about_img.jpg" alt="About" className="img-responsive" />
                            </div>
                        </div>
                        <div className="col-md-12 col-lg-6 col-sm-12 col-12">
        ...
        475,20" fill="none" id="path2" stroke="#05a4cd" strokeWidth="5px" strokeLinecap="round" className="anim-path" style={{ transition: 'stroke-dashoffset 2s ease-in-out', strokeDasharray: '572.872, 572.872', strokeDashoffset: '0px', display: 'inline' }} />
            ...
            <div className="works_wrapper float_left">
                <div className="work_banner_wrapper">
                    <img src="images/work_banner.jpg" alt="img" />
                </div>
                                        ...
                                        <div className="testimonial_slide_main_wrapper dark_top_testimonial">
                                            ...
                                            <div className="ts_img_social_wrapper">
                                                <div className="ts_client_img_wrapper">
                                                    <img src="images/ts1.png" className="img-responsive" alt="client_img" />
                                                </div>
                                    ...
                                    <div className="item">
                                        <div className="testimonial_slide_main_wrapper">
                                            ...
                                            <div className="ts_img_social_wrapper p2">
                                                ...
                                                <div className="ts_client_img_wrapper">
                                                    <img src="images/ts2.png" className="img-responsive" alt="client_img" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
