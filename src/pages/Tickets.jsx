                        ...
                        <div className="crm_customer_table_main_wrapper float_left">
                                                ...
                                                <div className="col-lg-12 col-md-12 col-sm-12 col-12">
                                                    <div className="sv_question_pop float_left">
                                                        ...
                                                        <div className="search_alert_box float_left">
                                                            ...
                                                            <div className="change_field">
                                                                <textarea className="form-control require" name="message" required rows={4} placeholder=" Message" defaultValue={""} />
                                                            </div>
                                                        </div>
                            ...
                            <div className="table-responsive">
                                <table className="myTable table datatables cs-table crm_customer_table_inner_Wrapper">
                                    <thead>
                                        <tr>
                                            <th className="width_table1">ticket no</th>
                                            <th className="width_table1">subject</th>
                                    ...
                                    <tbody>
                                        <tr className="background_white">
                                            ...
                                            <td>
                                                <div className="pretty p-svg p-curve">Hyip</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">Open</div>
                                            </td>
                                            <td>
                                        ...
                                        <tr className="background_white">
                                            ...
                                            <td>
                                                <div className="pretty p-svg p-curve">Withdraw Pending</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">Open</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">04/07/2019</div>
                                            </td>
                                        </tr>
                                        <tr className="background_white">
                                            <td>
                                            ...
                                            <td>
                                                <div className="pretty p-svg p-curve"> Hello</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">reOpen</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">12/07/2019</div>
                                            </td>
                                        </tr>
                                        <tr className="background_white">
                                            <td>
                                            ...
                                            <td>
                                                <div className="pretty p-svg p-curve"> Request</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">reOpen</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">5/07/2019</div>
                                            </td>
                                        </tr>
                                        <tr className="background_white">
                                            <td>
                                            ...
                                            <td>
                                                <div className="pretty p-svg p-curve"> Deposit</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">Open</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">15/08/2019</div>
                                            </td>
                                        </tr>
                                        <tr className="background_white">
                                            <td>
                                            ...
                                            <td>
                                                <div className="pretty p-svg p-curve"> Prueba</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">Open</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">10/08/2019</div>
                                            </td>
                                        </tr>
                                        <tr className="background_white">
                                            <td>
                                            ...
                                            <td>
                                                <div className="pretty p-svg p-curve"> Howejrpw</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">reOpen</div>
                                            </td>
                                        ...
                                        <tr className="background_white">
                                            ...
                                            <td>
                                                <div className="pretty p-svg p-curve"> Test</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">Open</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">5/08/2019</div>
                                            </td>
                                        </tr>
                                        <tr className="background_white">
                                            <td>
                                            ...
                                            <td>
                                                <div className="pretty p-svg p-curve"> Template</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">Open</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">6/08/2019</div>
                                            </td>
                                        </tr>
                                        <tr className="background_white">
                                            <td>
                                            ...
                                            <td>
                                                <div className="pretty p-svg p-curve">9/08/2019</div>
                                            </td>
                                        </tr>
                                        <tr className="background_white">
                                            <td>
                                            ...
                                            <td>
                                                <div className="pretty p-svg p-curve">Transaction</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">reOpen</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">23/08/2019</div>
                                            </td>
                                        </tr>
                                        <tr className="background_white">
                                            <td>
                                            ...
                                            <td>
                                                <div className="pretty p-svg p-curve">I didnt get payment</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">Open</div>
                                            </td>
                                        ...
                                        <tr className="background_white">
                                            ...
                                            <td>
                                                <div className="pretty p-svg p-curve"> payment</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">Open</div>
                                            </td>
                                        ...
                                        <tr className="background_white">
                                            ...
                                            <td>
                                                <div className="pretty p-svg p-curve"> Lots of withdraw requests</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">reOpen</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">27/08/2019</div>
                                            </td>
                                        </tr>
                                        <tr className="background_white">
                                            <td>
                                            ...
                                            <td>
                                                <div className="pretty p-svg p-curve">Ticket 2016</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">Open</div>
                                            </td>
                                        ...
                                        <tr className="background_white">
                                            ...
                                            <td>
                                                <div className="pretty p-svg p-curve">Ticket</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">Open</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">1/08/2019</div>
                                            </td>
                                        </tr>
                                        <tr className="background_white">
                                            <td>
                                            ...
                                            <td>
                                                <div className="pretty p-svg p-curve">Teste</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">Open</div>
                                            </td>
                                        ...
                                        <tr className="background_white">
                                            ...
                                            <td>
                                                <div className="pretty p-svg p-curve">3/08/2019</div>
                                            </td>
                                        </tr>
                                        <tr className="background_white">
                                            <td>
