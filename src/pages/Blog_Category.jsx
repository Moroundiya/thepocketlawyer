                ...
                <div className="container">
                    <div className="row">
                        <div className="col-xl-9 col-lg-8 col-md-12 col-sm-12 col-12">
                                ...
                                <div id="blogoneSlider" className="carousel slide" data-ride="carousel">
                                    ...
                                    <div className="carousel-inner" role="listbox">
                                        <div className="carousel-item active">
                                            <img src="images/blog2.jpg" className="img-responsive " alt="Image" />
                                        </div>
                                        <div className="carousel-item">
                                            <img src="images/blog1.jpg" className="img-responsive " alt="Image" />
                                        </div>
                                    </div>
                                    {/* Controls */}
                            ...
                            <div className="blog_category_box_wrapper blog_box_wrapper float_left">
                                <div className="blog_news_img_wrapper float_left">
                                    <img src="images/blog3.jpg" alt="blog_img" />
