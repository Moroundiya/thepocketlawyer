...
function Login() {
    return (
        <div>
            ...
            {/* login wrapper start */}
            <div className="login_wrapper fixed_portion float_left">
                <div className="container">
                    <div className="row">
                            ...
                            <div className="login_top_box float_left">
                                <div className="login_banner_wrapper">
                                    ...
                                    <div className="about_btn  facebook_wrap float_left">
                                        <a href="#">login with facebook <i className="fab fa-facebook-f" /></a>
                                    </div>
                                    <div className="about_btn google_wrap float_left">
                                        <a href="#">login with pinterest <i className="fab fa-pinterest-p" /></a>
                                    </div>
