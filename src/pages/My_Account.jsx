            ...
            <div className="l-main">
                ...
                <div className="account_wrapper float_left">
                    <div className="row">
                                    ...
                                    <div className="invest_details float_left">
                                        <table className="invest_table">
                                            <tbody>
                                                <tr>
                                                    <td className="invest_td1">interest today</td>
                                                    <td className="invest_td1"> : 11 nos</td>
                                                </tr>
                                                <tr>
                                                    <td className="invest_td1">interest this week</td>
                                                    <td className="invest_td1">: nos</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                        ...
                        <div className="col-md-4 col-lg-4 col-xl-3 col-sm-6 col-12">
                            <div className="investment_box_wrapper color_6 float_left">
                                <a href="#">
                                    <div className="investment_icon_wrapper float_left">
                                        <i className="far fa-money-bill-alt" />
                                        <h1>sampal</h1>
                                ...
                                <table className="myTable table datatables cs-table crm_customer_table_inner_Wrapper">
                                    ...
                                    <tbody>
                                        ...
                                        <tr className="background_white">
                                            ...
                                            <td>
                                                <div className="pretty p-svg p-curve">Interest Earning for investment</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">Bitcoin</div>
                                            </td>
                                        ...
                                        <tr className="background_white">
                                            ...
                                            <td className="flag">
                                                <div className="pretty p-svg p-curve">20/08/2019</div>
                                            </td>
                                            <td>
                                                <nav className="navbar navbar-expand">
                                                    <ul className="navbar-nav">
                                        ...
                                        <tr className="background_white">
                                            ...
                                            <td className="flag">
                                                <div className="pretty p-svg p-curve">28/08/2019</div>
                                            </td>
                                            <td>
                                                <nav className="navbar navbar-expand">
                                                    <ul className="navbar-nav">
                                        ...
                                        <tr className="background_white">
                                            ...
                                            <td>
                                                <div className="pretty p-svg p-curve">19000.00</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">Fund Received to Paypal</div>
                                            </td>
                                        ...
                                        <tr className="background_white">
                                            ...
                                            <td>
                                                <div className="pretty p-svg p-curve">3000.00</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">Fund Received to Paypal</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">OKpay</div>
                                            </td>
                                            <td className="flag">
                                                <div className="pretty p-svg p-curve">2/09/2019</div>
                                            </td>
                                        ...
                                        <tr className="background_white">
                                            ...
                                            <td>
                                                <div className="pretty p-svg p-curve">5000.00</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">Deposit made</div>
                                            </td>
                                            ...
                                            <td className="flag">
                                                <div className="pretty p-svg p-curve">04/09/2019</div>
                                            </td>
                                            <td>
                                                <nav className="navbar navbar-expand">
                                                    <ul className="navbar-nav">
