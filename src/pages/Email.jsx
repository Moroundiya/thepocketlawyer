                    ...
                    <ul className="nav user-menu">
                        <li className="nav-item nav-searchinputs">
                            <div className="top-nav-search">
                                ...
                                <form action="email.html#" className="dropdown">
                                    ...
                                    <ul>
                                        ...
                                        <li className="submenu">
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="email.html" className="active">Email</a></li>
                            ...
                            <aside id="aside" className="ui-aside">
                                <ul className="tab nav nav-tabs" id="myTab" role="tablist">
                                    <li className="nav-item" role="presentation">
                                        <a className="tablinks nav-link active" href="email.html#home" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" role="tab" aria-selected="true">
                                            <img src="https://dreamspos.dreamstechnologies.com/html/template/assets/img/icons/menu-icon.svg" alt="" />
                                        </a>
                                    </li>
                                    <li className="nav-item" role="presentation">
                                        <a className="tablinks nav-link" href="email.html#messages" id="messages-tab" data-bs-toggle="tab" data-bs-target="#product" role="tab" aria-selected="false">
                                            <img src="https://dreamspos.dreamstechnologies.com/html/template/assets/img/icons/product.svg" alt="" />
                                        </a>
                                    </li>
                                    <li className="nav-item" role="presentation">
                                        <a className="tablinks nav-link" href="email.html#profile" id="profile-tab" data-bs-toggle="tab" data-bs-target="#sales" role="tab" aria-selected="false">
                                            <img src="https://dreamspos.dreamstechnologies.com/html/template/assets/img/icons/sales1.svg" alt="" />
                                        </a>
                                    </li>
                                    <li className="nav-item" role="presentation">
                                        <a className="tablinks nav-link" href="email.html#report" id="report-tab" data-bs-toggle="tab" data-bs-target="#purchase" role="tab" aria-selected="true">
                                            <img src="https://dreamspos.dreamstechnologies.com/html/template/assets/img/icons/purchase1.svg" alt="" />
                                        </a>
                                    </li>
                                    <li className="nav-item" role="presentation">
                                        <a className="tablinks nav-link" href="email.html#set" id="set-tab" data-bs-toggle="tab" data-bs-target="#user" role="tab" aria-selected="true">
                                            <img src="https://dreamspos.dreamstechnologies.com/html/template/assets/img/icons/users1.svg" alt="" />
                                        </a>
                                    </li>
                                    <li className="nav-item" role="presentation">
                                        <a className="tablinks nav-link" href="email.html#set2" id="set-tab2" data-bs-toggle="tab" data-bs-target="#employee" role="tab" aria-selected="true">
                                            <img src="https://dreamspos.dreamstechnologies.com/html/template/assets/img/icons/calendars.svg" alt="" />
                                        </a>
                                    </li>
                                    <li className="nav-item" role="presentation">
                                        <a className="tablinks nav-link" href="email.html#set3" id="set-tab3" data-bs-toggle="tab" data-bs-target="#report" role="tab" aria-selected="true">
                                            <img src="https://dreamspos.dreamstechnologies.com/html/template/assets/img/icons/printer.svg" alt="" />
                                        </a>
                                    </li>
                                    <li className="nav-item" role="presentation">
                                        <a className="tablinks nav-link" href="email.html#set4" id="set-tab4" data-bs-toggle="tab" data-bs-target="#document" role="tab" aria-selected="true">
                                            <i data-feather="user" />
                                        </a>
                                    </li>
                                    <li className="nav-item" role="presentation">
                                        <a className="tablinks nav-link" href="email.html#set5" id="set-tab6" data-bs-toggle="tab" data-bs-target="#permission" role="tab" aria-selected="true">
                                            <i data-feather="file-text" />
                                        </a>
                                    </li>
                                    <li className="nav-item" role="presentation">
                                        <a className="tablinks nav-link" href="email.html#set6" id="set-tab5" data-bs-toggle="tab" data-bs-target="#settings" role="tab" aria-selected="true">
                        ...
                        <div className="row">
                            <div className="col-lg-3 col-md-12">
                                ...
                                <ul className="inbox-menu">
                                    <li className="active">
                                        <a href="javascript:void(0);"><i className="fas fa-download" /> Inbox <span className="mail-count">(5)</span></a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0);"><i className="far fa-star" /> Important</a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0);"><i className="far fa-paper-plane" /> Sent Mail</a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0);"><i className="far fa-file-alt" /> Drafts <span className="mail-count">(13)</span></a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0);"><i className="far fa-trash-alt" /> Trash</a>
                                    </li>
                                </ul>
                            </div>
                                                ...
                                                <table className="table table-inbox table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr className="clickable-row">
                                                            ...
                                                            <td><span className="mail-important"><i className="far fa-star starred" /></span></td>
            ...
            <div className="searchpart">
                <div className="searchcontent">
                    <div className="searchhead">
                        <h3>Search </h3>
                        <a id="closesearch"><i className="fa fa-times-circle" aria-hidden="true" /></a>
                    </div>
                    <div className="searchcontents">
                        ...
                        <div className="recentsearch">
                            ...
                            <ul>
                                <li>
                                    <h6><i className="fa fa-search me-2" /> Settings</h6>
                                </li>
                                <li>
                                    <h6><i className="fa fa-search me-2" /> Report</h6>
                                </li>
                                <li>
                                    <h6><i className="fa fa-search me-2" /> Invoice</h6>
                                </li>
                                <li>
                                    <h6><i className="fa fa-search me-2" /> Sales</h6>
                                </li>
                            </ul>
                        </div>
                    </div>
