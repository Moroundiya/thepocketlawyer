                        ...
                        <div className="col-xl-12 col-md-12 col-lg-12 col-sm-12 col-12">
                            <div className="view_profile_wrapper float_left">
                                <ul className="profile_list referal_list">
                                    <li><span className="detail_left_part">Active Referrals
                                    </span> <span className="detail_right_part">11
                                        </span>
                                    </li>
                                    <li><span className="detail_left_part">Inactive Referrals
                                    </span> <span className="detail_right_part">0
                                        </span>
                                    </li>
                                    <li><span className="detail_left_part">Total Referral Deposited Amount</span> <span className="detail_right_part">$0.00 USD
                                    </span>
                                    </li>
                                    <li><span className="detail_left_part">Referral Link</span> <span className="detail_right_part">http://demo.savehyip</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div className="row">
                        <div className="crm_customer_table_main_wrapper float_left">
                            <div className="crm_ct_search_wrapper">
                                <div className="crm_ct_search_bottom_cont_Wrapper">
                                </div>
                            </div>
                                ...
                                <table className="myTable table datatables cs-table crm_customer_table_inner_Wrapper">
                                    ...
                                    <tbody>
                                        <tr className="background_white">
                                            ...
                                            <td>
                                                <div className="pretty p-svg p-curve">ajaysuray</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">ajay</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">alemujona@gmail.com</div>
                                            </td>
                                        </tr>
                                        <tr className="background_white">
                                            <td>
                                            ...
                                            <td>
                                                <div className="pretty p-svg p-curve">akshay </div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">akshay handge</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">akshay@gmail.com</div>
                                            </td>
                                        </tr>
                                        <tr className="background_white">
                                            <td>
                                            ...
                                            <td>
                                                <div className="pretty p-svg p-curve">farhan shaikh</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">farhan</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">faruua@gmail.com</div>
                                            </td>
                                        </tr>
                                        <tr className="background_white">
                                            <td>
                                            ...
                                            <td>
                                                <div className="pretty p-svg p-curve">nachi</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">mishara</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">midhrjona@gmail.com</div>
                                            </td>
                                        </tr>
                                        <tr className="background_white">
                                            <td>
                                            ...
                                            <td>
                                                <div className="pretty p-svg p-curve">subhi</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">kumawat</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">surbhiujona@gmail.com</div>
                                            </td>
                                        </tr>
                                        <tr className="background_white">
                                            <td>
                                            ...
                                            <td>
                                                <div className="pretty p-svg p-curve">shruti</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">shruti jaiwal</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">shrutiujona@gmail.com</div>
                                            </td>
                                        </tr>
                                        <tr className="background_white">
                                            <td>
                                            ...
                                            <td>
                                                <div className="pretty p-svg p-curve">mini</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">min22</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">mini@gmail.com</div>
                                            </td>
                                        </tr>
                                        <tr className="background_white">
                                            <td>
                                            ...
                                            <td>
                                                <div className="pretty p-svg p-curve">sunita amliyar</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">sunita</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">sunitaa@gmail.com</div>
                                            </td>
                                        </tr>
                                        <tr className="background_white">
                                            <td>
                                            ...
                                            <td>
                                                <div className="pretty p-svg p-curve">soan</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">mishti</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">sona@gmail.com</div>
                                            </td>
                                        </tr>
                                        <tr className="background_white">
                                            <td>
                                            ...
                                            <td>
                                                <div className="pretty p-svg p-curve">nick jones</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">nick</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">nick@gmail.com</div>
                                            </td>
                                        </tr>
                                        <tr className="background_white">
                                            <td>
                                            ...
                                            <td>
                                                <div className="pretty p-svg p-curve">priyu</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">menthaan</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">priyu@gmail.com</div>
                                            </td>
                                        </tr>
                                        <tr className="background_white">
                                            <td>
                                            ...
                                            <td>
                                                <div className="pretty p-svg p-curve">gggrtghfgn</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">rfgf</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">gffgf@gmail.com</div>
                                            </td>
                                        </tr>
                                        <tr className="background_white">
                                            <td>
                                            ...
                                            <td>
                                                <div className="pretty p-svg p-curve">djktrrgn</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">yyyrre</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">gfgf@gmail.com</div>
                                            </td>
                                        </tr>
                                        <tr className="background_white">
                                            <td>
                                            ...
                                            <td>
                                                <div className="pretty p-svg p-curve">aamp</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">amprt</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">ammf@gmail.com</div>
                                            </td>
                                        </tr>
                                        <tr className="background_white">
                                            <td>
                                            ...
                                            <td>
                                                <div className="pretty p-svg p-curve">ravidlin01</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">ravi</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">ravi01@gmail.com</div>
                                            </td>
                                        </tr>
                                        <tr className="background_white">
                                            <td>
                                            ...
                                            <td>
                                                <div className="pretty p-svg p-curve">maneku94584</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">maneku</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">maneku1@gmail.com</div>
                                            </td>
                                        </tr>
                                        <tr className="background_white">
                                            <td>
                                            ...
                                            <td>
                                                <div className="pretty p-svg p-curve">ajay04</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">ajay</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">ajay041@gmail.com</div>
                                            </td>
                                        </tr>
                                        <tr className="background_white">
                                            <td>
                                        ...
                                        <tr className="background_white">
                                            ...
                                            <td>
                                                <div className="pretty p-svg p-curve">tytytry555b</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">dfrg</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">gfftr@gmail.com</div>
                                            </td>
                                        </tr>
                                        <tr className="background_white">
                                            <td>
