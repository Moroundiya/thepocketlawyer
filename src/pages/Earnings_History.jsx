                                ...
                                <table className="myTable table datatables cs-table crm_customer_table_inner_Wrapper">
                                    ...
                                    <tbody>
                                        <tr className="background_white">
                                            ...
                                            <td>
                                                <div className="pretty p-svg p-curve">Referral Commission</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">Bitcoin</div>
                                            </td>
                                            <td className="flag">
                                                <div className="pretty p-svg p-curve">03/07/2019 (11:00:52)</div>
                                            </td>
                                            <td>
                                                <nav className="navbar navbar-expand">
                                                    <ul className="navbar-nav">
                                                        ...
                                                        <li className="nav-item dropdown">
                                                            ...
                                                            <div className="dropdown-menu"> <a className="dropdown-item" href="#">Edit</a>
                                        ...
                                        <tr className="background_white">
                                            ...
                                            <td className="flag">
                                                <div className="pretty p-svg p-curve">20/07/2019 (15:10:52)</div>
                                            </td>
                                            <td>
                                                <nav className="navbar navbar-expand">
                                                    <ul className="navbar-nav">
                                        ...
                                        <tr className="background_white">
                                            ...
                                            <td>
                                                <div className="pretty p-svg p-curve">Direct commission earning for Deposit</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">Bitcoin</div>
                                            </td>
                                            <td className="flag">
                                                <div className="pretty p-svg p-curve">20/07/2019 (14:80:02)</div>
                                            </td>
                                            <td>
                                                <nav className="navbar navbar-expand">
                                                    <ul className="navbar-nav">
                                        ...
                                        <tr className="background_white">
                                            ...
                                            <td className="flag">
                                                <div className="pretty p-svg p-curve">20/07/2019 (02:01:55)</div>
                                            </td>
                                            <td>
                                                <nav className="navbar navbar-expand">
                                                    <ul className="navbar-nav">
                                        ...
                                        <tr className="background_white">
                                            ...
                                            <td className="flag">
                                                <div className="pretty p-svg p-curve">20/07/2019 (08:40:30)</div>
                                            </td>
                                            <td>
                                                <nav className="navbar navbar-expand">
                                                    <ul className="navbar-nav">
                                        ...
                                        <tr className="background_white">
                                            ...
                                            <td className="flag">
                                                <div className="pretty p-svg p-curve">20/07/2019 (02:53:47)</div>
                                            </td>
                                            <td>
                                                <nav className="navbar navbar-expand">
                                                    <ul className="navbar-nav">
                                        ...
                                        <tr className="background_white">
                                            ...
                                            <td className="flag">
                                                <div className="pretty p-svg p-curve">20/07/2019 ( 02:55:38)</div>
                                            </td>
                                            <td>
                                                <nav className="navbar navbar-expand">
                                                    <ul className="navbar-nav">
                                        ...
                                        <tr className="background_white">
                                            ...
                                            <td className="flag">
                                                <div className="pretty p-svg p-curve">20/07/2019 ( 18:53:09)</div>
                                            </td>
                                            <td>
                                                <nav className="navbar navbar-expand">
                                                    <ul className="navbar-nav">
                                        ...
                                        <tr className="background_white">
                                            ...
                                            <td>
                                                <div className="pretty p-svg p-curve">Deposit made</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">Bitcoin</div>
                                            </td>
                                            <td className="flag">
                                                <div className="pretty p-svg p-curve">20/07/2019 ( 20:03:27)</div>
                                            </td>
                                            <td>
                                                <nav className="navbar navbar-expand">
                                                    <ul className="navbar-nav">
                                        ...
                                        <tr className="background_white">
                                            ...
                                            <td className="flag">
                                                <div className="pretty p-svg p-curve">20/07/2019 (1:23:32)</div>
                                            </td>
                                            <td>
                                                <nav className="navbar navbar-expand">
                                                    <ul className="navbar-nav">
                                        ...
                                        <tr className="background_white">
                                            ...
                                            <td className="flag">
                                                <div className="pretty p-svg p-curve">20/07/2019 ( 01:01:55)</div>
                                            </td>
                                            <td>
                                                <nav className="navbar navbar-expand">
                                                    <ul className="navbar-nav">
                                        ...
                                        <tr className="background_white">
                                            ...
                                            <td>
                                                <div className="pretty p-svg p-curve">Fund Received to Paypal</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">Bitcoin</div>
                                            </td>
                                            <td className="flag">
                                                <div className="pretty p-svg p-curve">20/07/2019 ( 21:01:55)</div>
                                            </td>
                                            <td>
                                                <nav className="navbar navbar-expand">
                                                    <ul className="navbar-nav">
                                        ...
                                        <tr className="background_white">
                                            ...
                                            <td>
                                                <div className="pretty p-svg p-curve">payza</div>
                                            </td>
                                            <td className="flag">
                                                <div className="pretty p-svg p-curve">20/07/2019 ( 01:01:55)</div>
                                            </td>
...
export default Earnings_History