    ...
    return (
        <div>
            ...
            <div className="l-main">
                ...
                <div className="plan_investment_wrapper float_left">
                    <div className="row">
                        ...
                        <div className="col-xl-3 col-md-6 col-lg-6 col-sm-6 col-12">
                            <div className="investment_box_wrapper sv_pricing_border float_left">
                                <div className="investment_icon_circle">
                                    <i className="flaticon-movie-tickets" />
                                </div>
                        ...
                        <div className="col-xl-3 col-md-6 col-lg-6 col-sm-6 col-12">
                            <div className="investment_box_wrapper sv_pricing_border float_left">
                                <div className="investment_icon_circle blue_icon_circle">
                                    <i className="flaticon-progress-report" />
                                </div>
                ...
                <div className="payment_mode_wrapper float_left">
                    <div className="row">
                        <div className="col-md-12 col-lg-12 col-sm-12 col-12">
                            <div className="sv_heading_wraper">
                        ...
                        <div className="col-md-12 col-lg-12 col-sm-12 col-12">
                            <div className="payment_radio_btn_wrapper float_left">
                                <div className="radio">
                                    <input type="radio" name="ratio" id="poa" defaultValue="option1" defaultChecked />
                                    <label htmlFor="poa"><img src="images/partner1.png" alt="img" /></label>
                                </div>
                                <div className="radio">
                                    <input type="radio" name="ratio" id="job" defaultValue="option1" />
                                    <label htmlFor="job"><img src="images/partner4.png" alt="img" /></label>
                                </div>
                                <div className="radio">
                                    <input type="radio" name="ratio" id="pay1" defaultValue="option1" />
                                    <label htmlFor="pay1"><img src="images/partner2.png" alt="img" /></label>
                                </div>
                                <div className="about_btn acc_balance_btn float_left">
