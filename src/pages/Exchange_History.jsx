                                ...
                                <table className="myTable table datatables cs-table crm_customer_table_inner_Wrapper">
                                    ...
                                    <tbody>
                                        <tr className="background_white">
                                            ...
                                            <td>
                                                <div className="pretty p-svg p-curve">Fund Received of Exchange from Pexpay</div>
                                            </td>
                                            <td>
                                        ...
                                        <tr className="background_white">
                                            ...
                                            <td>
                                                <div className="pretty p-svg p-curve">	Fund Received of Exchange from PerfectMoney</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">Bitcoin</div>
                                            </td>
                                        ...
                                        <tr className="background_white">
                                            ...
                                            <td>
                                                <div className="pretty p-svg p-curve">Fund Received of Exchange from Paypal</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">Bitcoin</div>
                                            </td>
...
export default Exchange_History