                                ...
                                <table className="myTable table datatables cs-table crm_customer_table_inner_Wrapper">
                                    ...
                                    <tbody>
                                        <tr className="background_white">
                                            ...
                                            <td>
                                                <div className="pretty p-svg p-curve">Withdraw request made in PerfectMoney</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">PerfectMoney</div>
                                            </td>
                                            <td className="flag">
                                        ...
                                        <tr className="background_white">
                                            ...
                                            <td>
                                                <div className="pretty p-svg p-curve">Withdraw request made in Paypal</div>
                                            </td>
                                            <td>
                                                <div className="pretty p-svg p-curve">Paypal</div>
                                            </td>
                                            <td className="flag">
...
export default Pending_History