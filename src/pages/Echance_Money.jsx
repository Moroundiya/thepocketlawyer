    ...
    return (
        <div>
            ...
            <div className="l-main">
                ...
                {/*  exchange wrapper start */}
                <div className="payment_transfer_Wrapper float_left">
                    <div className="row">
                        <div className="col-md-12 col-lg-12 col-sm-12 col-12">
                            <div className="sv_heading_wraper heading_center">
                                <h3>Make exchange</h3>
                            </div>
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-md-12 col-xl-6 offset-xl-3 col-lg-8 offset-lg-2 col-sm-12 col-12">
                            <div className="change_password_wrapper float_left">
                                <div className="change_pass_field float_left">
                                    <div className="payment_gateway_wrapper payment_select_wrapper">
                                        <label>exchange gateway from :</label>
                                        <select>
                                    ...
                                    <div className="change_field">
                                        ...
                                        <input type="password" name="password" placeholder="000 USD" />
                                    </div>
                                    <div className="change_field">
                                        <label>exchange gateway to :</label>
                                        <input type="password" name="password" placeholder="choose your exchange gateway" />
                                    </div>
                                    <div className="change_field">
                                        <label>enter exchange money :</label>
                                        <input type="password" name="password" placeholder="000 USD" />
                                    </div>
                                    <div className="change_field">
                                        <label> exchange rate fee : &nbsp; 0%</label>
                                    </div>
